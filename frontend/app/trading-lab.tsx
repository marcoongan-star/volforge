  ...
  return (
    <main className="lab-shell">
      ...
      <section className="distribution-section">
        ...
        <div className="sign-diagnostic"><div><small>EXACT SIGN TEST · TIES EXCLUDED</small><h3>Frequency and average can disagree.</h3><p>The directional agent wins only 163 of 500 paired paths. Under an equal win-frequency null, that imbalance has a two-sided p-value below 0.0001.</p></div><dl><div><dt>DIRECTIONAL WINS</dt><dd>163</dd></div><div><dt>MAKER WINS</dt><dd>337</dd></div><div><dt>NON-TIED PAIRS</dt><dd>500</dd></div><div><dt>EXACT P-VALUE</dt><dd>&lt;0.0001</dd></div></dl><p>The mean-P&amp;L interval still crosses zero because rare, large directional gains offset many losses. The sign test asks about the typical path; the confidence interval asks about the average dollars. Reporting both prevents one statistic from hiding the payoff shape.</p></div>
        <div className="tail-diagnostic"><div><small>EXPECTED SHORTFALL · 400 BOOTSTRAP RESAMPLES</small><h3>How uncertain is the left tail?</h3><p>Each interval repeatedly resamples the 500 synthetic P&amp;Ls. It measures simulation sampling error under this model—not uncertainty about whether the model matches a live market.</p></div><dl><div><dt>MAKER ES · 5%</dt><dd>−$640.30</dd><span>95%: −$730.91 to −$540.62</span></div><div><dt>DIRECTIONAL ES · 5%</dt><dd>−$2,090.54</dd><span>95%: −$2,090.54 to −$2,090.54</span></div></dl><p>The directional interval collapses because every sampled loss beyond its 5% threshold hits the same maximum-loss floor. That is a property of this bounded long-option payoff—not proof that the real-world tail is known exactly.</p></div>
        <div className="variance-diagnostic"><div><small>COMMON-RANDOM-NUMBER CHECK</small><h3>Did pairing improve precision?</h3></div><dl><div><dt>UNPAIRED SE</dt><dd>$146.29</dd></div><div><dt>PAIRED SE</dt><dd>$145.90</dd></div><div><dt>PATH CORRELATION</dt><dd>+0.0284</dd></div><div><dt>EFFICIENCY RATIO</dt><dd>1.0027×</dd></div></dl><p>Pairing lowers standard error by only 0.27% here. The agents’ path results have little positive correlation, so common random numbers add only a modest precision benefit in this configuration.</p></div>
        <div className="precision-diagnostic"><div><small>PRECISION TARGET · $250 MEAN DIFFERENCE</small><h3>How many paths are enough?</h3><p>The current 95% margin is wider than the target. The planner uses the observed paired dispersion, not a claim that the effect is real.</p></div><dl><div><dt>CURRENT PATHS</dt><dd>500</dd></div><div><dt>CURRENT MARGIN</dt><dd>±$285.95</dd></div><div><dt>REQUIRED PATHS</dt><dd>655</dd></div><div><dt>ADDITIONAL</dt><dd>155</dd></div></dl></div>
        <div className="precision-diagnostic"><div><small>POWER TARGET · DETECT A $500 DIFFERENCE</small><h3>Would this experiment notice a meaningful effect?</h3><p>A two-sided 5% test targets 80% power. This asks a different question from interval precision: how often would the design detect a specified effect if that effect truly existed?</p></div><dl><div><dt>CURRENT PATHS</dt><dd>500</dd></div><div><dt>ACHIEVED POWER</dt><dd>92.9%</dd></div><div><dt>REQUIRED PATHS</dt><dd>335</dd></div><div><dt>ADDITIONAL</dt><dd>0</dd></div></dl></div>
